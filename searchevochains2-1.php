...
try {
    ...
    $sql = 'SELECT p.pokeId, p.pokename, type, evolves_from, evolves_to
            ...
            AND t.type="' . $_POST["type"] . '" AND p.evolves_from!=0 order by p.pokeId';
    $q = $pdo->query($sql);
    ...
    <div style="background-color:midnightblue;color:white;padding:2%;">
        <div id="container">
            ...
            <div style="background-color:midnightblue;color:white;padding:2%;">
                ...
                <br>
                <a href="http://cmpsc431-s3-g-12.vmhost.psu.edu/showevochain2.php"><button type="button" style="font-size: 20px;">Search for another Evolution Chain</button></a>
</div>
</div>
</div>
</body>
